...
global.status = Object.freeze({
   ...
   errorF: Func.texted('bold', 'Fitur nya masih error'),
   premium: Func.texted('bold', 'Fitur ini khusus user premium doang bang'),
   owner: Func.texted('bold', 'Fitur ini khusus buat om sho'),
   god: Func.texted('bold', 'kamu tidak punya hak untuk memakai command ini'),
